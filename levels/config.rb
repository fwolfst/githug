difficulty 1
description "Set up your hg name and email, this is important so that your commits can be identified"
...
hint do
  puts "These settings are config settings.  You should run `hg help config` if you are stuck"
end
